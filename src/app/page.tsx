      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1 ">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4 relative after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:-top-0.5 after:left-0 after:bg-blue-600 after:origin-bottom-left after:transition-transform after:hover:scale-x-100 after:rounded-sm after:duration-300">
              <span className="text-sm font-medium text-blue-600">Step 1</span>
              <span className="text-xl font-semibold">
                Sign up for an account
              </span>
              <span className="mt-2 relative text-zinc-700">
